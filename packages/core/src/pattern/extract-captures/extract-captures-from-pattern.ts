...
import type { CapturesAt } from './captures-at'
import type { ExtractFromPropertyValue } from './extract-from-property-value'
import type { ReKeyIfSingle } from './re-key-if-single'
import type { StripWith } from './strip-with'
