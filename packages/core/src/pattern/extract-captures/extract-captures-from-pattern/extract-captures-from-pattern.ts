...
import type BindExclusiveTypes from '@/ast/node-with-bind/bind-exclusive/types'
 ...
 */
export type ExtractCapturesFromPattern<P, Key extends string = ''> =
        ...
        : P extends NodeWithSeqTypes.SeqBranded<infer Elements>
          ? Elements extends readonly unknown[]
            ? UnionToIntersection<
              ...
              >
            : {}
          : P extends NodeWithWithTypes.WithBranded<infer WB>
            ? Overwrite<ExtractCapturesFromPattern<StripWith<P>, Key>, WB & {}>
            : P extends BindExclusiveTypes.OnlyBranded<infer OB>
              ? OB & {}
