 ...
 */
const READS_TYPE_ARGUMENTS = new Set([
  'CallExpression',
 ...
 * needs.
 */
const NEEDS_PARENS_AS_OPERAND = new Set([
  'TSAsExpression',
...
/**
 * Type kinds that need parentheses as an array's element or an operator's
 * operand.
 */
...
export const printNode = (node: unknown) =>
  print(toRecastShape(node) as Parameters<typeof print>[0]).code
